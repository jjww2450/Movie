					...
					<center>
						...
						<div class="col-md-9">
							...
							<font size="4">
								...
								<s:else>
								<a href="/Movie/movieService!getPageListByName2?page=1">第一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
								<a href="/Movie/movieService!getPageListByName2?page=<s:property value="%{pageBean.currentPage-1}"/>">上一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
								</s:else>
								<s:if test="%{pageBean.currentPage!= pageBean.totalPage}">
								<a href="/Movie/movieService!getPageListByName2?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
								<a href="/Movie/movieService!getPageListByName2?page=<s:property value="pageBean.totalPage"/>">最后一页</a>
								</s:if>
